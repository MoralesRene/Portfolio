...
function Contact() {
    return (
        <footer id="Contact" className="flex flex-col justify-center gap-y-[20px] items-center w-full  bg-cyan-500 pt-[50px]  pb-[25px]">
            ...
            <form action="https://getform.io/f/f6f511a9-6f65-4cb9-ab95-8fbba4e49ec1" encType="multipart/form-data" method="POST" className="rounded-xl px-2 py-[20px]  flex flex-col gap-y-[13px] justify-center 
             bg-cyan-800/70 w-[90%] text-white md:w-[600px] lg:max-w-[700px]">
                ...
                className="placeholder:duration-300 self-center indent-1 w-[80%] border-t-0 border-l-0 border-r-0 border-b-[3px] outline-none
                ...
                className="placeholder:duration-300 self-center indent-1 w-[80%] border-t-0 border-l-0 border-r-0 border-b-[3px] outline-none bg-transparent
                ...
                <input type="text" placeholder="Escriba su asunto" id="Asunto" name="subject"
                className="placeholder:duration-300 self-center indent-1 w-[80%] border-t-0 border-l-0 border-r-0 border-b-[3px] outline-none
                 border-cyan-500 bg-transparent placeholder:text-white/50 hover:placeholder:text-white"/>
                ...
                className="placeholder:duration-300 w-[80%] self-center border-t-[3px] border-l-[3px] border-r-[3px] border-b-[3px] outline-none text-black
